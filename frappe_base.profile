config:
  cloud-init.vendor-data: "#cloud-config\nssh_authorized_keys:\n  - ssh-rsa 
    ...
    (run 'apt-get update').\n# Note, if packages are given, or package_upgrade is
    true, then\n# update will be done independent of this setting.\n# Default: false\npackage_update:
    true\n\n# Upgrade the instance on first boot\n# Default: false\npackage_upgrade:
    true\n\n# Install additional packages on first boot\n# Default: none\n# if packages
    are specified, then package_update will be set to true\n# packages may be supplied
    as a single package name or as a list\n# with the format [<package>, <version>]
